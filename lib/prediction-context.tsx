      ...
      const samplePredictions: PredictionResult[] = [
        {
          ...
          data: {
            ...
            interest: 70,
            subjects: [
              { name: "Mathematics", marks: 40 },
              { name: "Physics", marks: 38 },
              { name: "Computer Science", marks: 42 },
            ],
            practicalSubjects: [
              { name: "Physics Lab", marks: 20 },
              { name: "Computer Science Lab", marks: 25 },
            ],
          },
        },
        {
          ...
          tips: ["Focus more on Physics as it's your weakest subject."],
          weakestSubject: "Physics",
          weakestPractical: "Physics Lab",
          data: {
            attendance: 70,
            participation: 8,
            assignment: "yes",
            ...
            subjects: [
              ...
              { name: "Computer Science", marks: 45 },
            ],
            practicalSubjects: [
              { name: "Physics Lab", marks: 22 },
              { name: "Computer Science Lab", marks: 26 },
            ],
          },
        },
        {
          ...
          data: {
            ...
            subjects: [
              ...
              { name: "Physics", marks: 43 },
              { name: "Computer Science", marks: 47 },
            ],
            practicalSubjects: [
              { name: "Physics Lab", marks: 24 },
              { name: "Computer Science Lab", marks: 27 },
            ],
          },
        },
      ]
